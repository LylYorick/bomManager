...
public class MaterialView implements Serializable{
	...
	public void  clone(MaterialView materialView){
		try {
			BeanUtils.copyProperties(this, materialView);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
/*	public Material  castToSon(){
	...
	public boolean equals(Object obj) {
		  if (null == obj)
	            return false;
	        if (!(obj instanceof MaterialView))
	            return false;
	        else
	        {
	        	MaterialView  material = (MaterialView) obj;
