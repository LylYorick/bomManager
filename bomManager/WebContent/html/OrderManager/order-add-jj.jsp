...
<article class="page-container">
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-4 col-sm-3"> <span class="c-red">输入零件名称或项目名称</span></div>
	</div>
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-4 col-sm-3"> <span class="c-red">输入材料型号，材料规格或其他材料要求</span></div>
	</div>
		<div class="row cl">
