...
<article class="page-container">
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-4 col-sm-3"> <span class="c-red">输入物品名称或项目名称</span></div>
	</div>
	...
	<div class="row cl">
		...
		<div class="form-label col-xs-4 col-sm-3">
			<select class="multiSelect"   name="entity.orderType" id="orderType">
	   			<option value="国内采购">国内采购</option>
	   			<option value="国外采购">国外采购</option>
	   			<option value="设备租用">设备租用</option>
		  	</select>
		</div>
		<div class="formControls col-xs-4 col-sm-3"> <span class="c-red">输入物品所属类型及型号</span></div>
	</div>
	<div class="row cl">
		...
		<div class="formControls col-xs-4 col-sm-3"> <span class="c-red">输入物品材料，品牌或其他要求</span></div>
	</div>
	<div class="row cl">
		<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>规格描述：</label>
