...
<article class="page-container">
	...
	<div class="row cl">
		<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>确定时间:</label>
		<div class="formControls col-xs-8 col-sm-3">
			<label class="form-label " ><s:date name="entity.confirmTime" format="yyyy-MM-dd hh:mm:ss"/></label>
		</div>
	</div>
	<div class="row cl">
		<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>确定人:</label>
		<div class="formControls col-xs-8 col-sm-3">
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-3">
		<input type="text" class="input-text Wdate"  onclick="WdatePicker({isShowClear:false,readOnly:true})"  placeholder="" id="deliveryTime" name="entity.deliveryTime"  >
		</div>
	</div>
	<div class="row cl">
		<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>结算金额:</label>
		<div class="formControls col-xs-8 col-sm-3">
			<input type="text" class="input-text"  placeholder="" id="payment" name="entity.payment" >
		</div>
	</div>
	<div class="row cl">
		<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>结算方式:</label>
		<div class="formControls col-xs-8 col-sm-3">
			<input type="text" class="input-text"  placeholder="" id="payWay" name="entity.payWay" >
		</div>
	</div>
	<div class="row cl">
		<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>运输方式:</label>
		<div class="formControls col-xs-8 col-sm-3">
			<input type="text" class="input-text"  placeholder="" id="express" name="entity.express" >
		</div>
	</div>
	<div class="row cl">
		<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>快递单号:</label>
		<div class="formControls col-xs-8 col-sm-3">
			<input type="text" class="input-text"  placeholder="" id="expressNum" name="entity.expressNum" >
		</div>
	</div>
	<div class="row cl">
...
$(function(){
	$("#form-user-add").validate({
		...
		submitHandler:function(form){
			layer.confirm('是否确认完成订单？',function(){
				$(form).ajaxSubmit({
					type: 'post',
					url: "order-doComplete", 
