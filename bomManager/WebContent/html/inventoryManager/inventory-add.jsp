...
<article class="page-container">
	...
	<div class="row cl">
		...
		<%-- <s:text name="#request.inventoryTrees"></s:text> --%>
			<span class="select-box">
				<select class="select"  name="entity.id.partnumber" id="partnumber">
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			<span class="select-box">
				<select class="select"  name="entity.id.supplierName" id="supplierName">
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text"  placeholder="" id="partUnit" name="entity.qty" >
		</div>
	</div>
	<div class="row cl">
